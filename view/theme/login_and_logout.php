<head>
    ...
    <link href="<?= Router::webroot('theme/admin/sb-admin-2.css')?>" rel="stylesheet">
...
<body class="bg-gradient-primary">
    ...
    <script src="<?= Router::webroot('js/vendor/jquery/jquery.min.js')?> "></script>
    <script src="<?= Router::webroot('js/vendor/sb-admin/bootstrap/js/bootstrap.bundle.min.js')?>"></script>

    <!-- Core plugin JavaScript-->
    <script src="<?= Router::webroot('js/vendor/jquery-easing/jquery.easing.min.js')?>"></script>
